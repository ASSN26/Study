...
from model import load_tokenizer_processor, load_model, get_lora_model
...
def main(args):
    ...
    lora_model = get_lora_model(args, model)

    train(args, tokenizer, train_dataset, eval_dataset, lora_model)
